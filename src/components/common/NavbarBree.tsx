              ...
              <div className="py-6 space-y-1">
                ...
                <div className="pt-6 px-4 border-t border-gray-100 mt-4">
                  <Link
                    to="/contact"
                    onClick={closeMenu}
                    className="block text-center bg-blue-400 hover:bg-blue-500 active:bg-blue-600 text-gray-900 font-semibold px-6 py-3.5 rounded-full shadow-sm transition-all duration-200 text-base"
                  >
                    Get started
                  </Link>
                </div>
